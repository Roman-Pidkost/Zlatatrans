        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/admin/make">Марка</a></li>
    ...
    <div class="col-md-8 col-xs-12">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <form:form class="form-horizontal" action="/admin/make" method="POST" modelAttribute="make">
        ...
        <c:forEach items="${makes}" var="make">
            <div class="row">
                <div class="col-md-4 col-xs-4">${make.name}</div>
                <div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/make/update/${make.id}">&#x21ba;</a></div>
                <div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/make/delete/${make.id}">&#10006;</a></div>
            </div>
        </c:forEach>
    </div>
    <div class="col-md-2 col-xs-12"></div>
