        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/admin/fuelType">Топливо</a></li>
    ...
    <div class="col-md-7 col-xs-12">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <form:form class="form-horizontal" action="/admin/fuelType" method="POST" modelAttribute="fuelType">
        ...
        <c:forEach items="${fuelTypes}" var="fuelType">
            <div class="row">
                <div class="col-md-4 col-xs-4">${fuelType.name}</div>
                <div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/fuelType/update/${fuelType.id}">&#x21ba;</a></div>
                <div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/fuelType/delete/${fuelType.id}">&#10006;</a></div>
            </div>
        </c:forEach>
    </div>
