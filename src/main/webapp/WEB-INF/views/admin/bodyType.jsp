        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/admin/bodyType">Тип кузова</a></li>
    ...
    <div class="col-md-7 col-xs-12">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <form:form class="form-horizontal" action="/admin/bodyType" method="POST" modelAttribute="bodyType">
        ...
        <c:forEach items="${bodyTypes}" var="bodyType">
            <div class="row">
                <div class="col-md-4 col-xs-4">${bodyType.name}</div>
                <div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/bodyType/update/${bodyType.id}">&#x21ba;</a></div>
                <div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/bodyType/delete/${bodyType.id}">&#10006;</a></div>
            </div>
        </c:forEach>
    </div>
