        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/admin/transmission">Коробка передач</a></li>
    ...
    <div class="col-md-7 col-xs-12">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <form:form class="form-horizontal" action="/admin/transmission" method="POST" modelAttribute="transmission">
        ...
        <c:forEach items="${transmissions}" var="transmission">
            <div class="row">
                <div class="col-md-4 col-xs-4">${transmission.name}</div>
                <div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/transmission/update/${transmission.id}">&#x21ba;</a></div>
                <div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/transmission/delete/${transmission.id}">&#10006;</a></div>
            </div>
        </c:forEach>
    </div>
