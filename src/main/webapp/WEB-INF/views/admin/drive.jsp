        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/admin/drive">Привід</a></li>
    ...
    <div class="col-md-7 col-xs-12">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <form:form class="form-horizontal" action="/admin/drive" method="POST" modelAttribute="drive">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 col-sm-offset-2"><label class="errors" for="name" style="color:red;text-align:left;" class="control-label"><form:errors path="name"/></label></div>
                    </div>
                    <div class="form-group">
        ...
        <c:forEach items="${drives}" var="drive">
            <div class="row">
                <div class="col-md-4 col-xs-4">${drive.name}</div>
                <div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/drive/update/${drive.id}">&#x21ba;</a></div>
                <div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/drive/delete/${drive.id}">&#10006;</a></div>
            </div>
        </c:forEach>
    </div>
