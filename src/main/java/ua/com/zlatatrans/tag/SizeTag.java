...
public class SizeTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		sw.append("<div class='dropdown'><button class='size-button dropdown-toggle' type='button' data-toggle='dropdown'>");
		sw.append(title);
